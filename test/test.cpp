...
/**
 * @brief Compare screened_coulomb calculations to Robinson1970 published tables
 *
 * \test
 * Compare screened_coulomb calculations to Robinson1970 published tables.
 * - Data for Moliere screening, e = 0.01, s = 0:1:40.
 * - Quantities: apsis, scattering angle, cross-section.
 *
 *
 * @tparam Q_ the quadrature to employ
 * @tparam N_ qud order
 */
...
/**
 * @brief Compare results of low-order approximations to an accurate high-order (N=128)
 * Gauss-Cheb integration
 *
 * \test
 * Compare results of low-order approximations to an accurate high-order (N=128)
 * Gauss-Cheb integration
 * - Various (e,s) combinations.
 * - Compare scattering angle, cross-section, stopping cross-section.
 *
 *
 * @tparam S_ type of screening
 * @tparam Q_ quadrature to use
 * @tparam N quad order
 */
...
/**
 * @brief Timimng benchmark
 *
 * \test
 * Timimng benchmark
 * - Compare the efficiency of various numerical schemes.
 *
 *
 * @tparam S_ type of screening
 * @tparam Q_ quadrature to use
 * @tparam N quad order
 * @param M # of iterations
 */
template <Screening S_, Quadrature Q_, int N>
void test3(size_t M);
...
int main()
{
    xs_lab<Screening::ZBL, Quadrature::Lobatto4> xxs(1, 1, 2, 2);
